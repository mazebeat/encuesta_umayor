...
ifs_3_should_warn:{
	options = {conditionals: true, dead_code: true, evaluate: true, booleans: true};
	input:{
		if (x && !(x + "1") && y) {
			var qq;
			foo()
...
ifs_5:{
	options = {if_return: true, conditionals: true, comparisons: true};
	input:{
		function f() {
			if (foo) {
				return
...
ifs_6:{
	options = {conditionals: true, comparisons: true};
	input:{
		if (!foo && !bar && !baz && !boo) {
			x = 10
		} else {
