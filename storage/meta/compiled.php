...
class Application extends Container implements HttpKernelInterface, TerminableInterface, ApplicationContract, ResponsePreparer
{
    ...
    {
        return 'D:\\xampp\\htdocs\\github\\encuesta_umayor\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation' . '/start.php';
    }
    ...
    {
        $aliases = array('app' => array('Illuminate\\Foundation\\Application', 'Illuminate\\Contracts\\Container\\Container', 'Illuminate\\Contracts\\Foundation\\Application'), 'artisan' => 'Illuminate\\Console\\Application', 'auth' => 'Illuminate\\Auth\\AuthManager', 'auth.driver' => array('Illuminate\\Auth\\Guard', 'Illuminate\\Contracts\\Auth\\Authenticator'), 'auth.reminder.repository' => 'Illuminate\\Auth\\Reminders\\ReminderRepositoryInterface', 'blade.compiler' => 'Illuminate\\View\\Compilers\\BladeCompiler', 'cache' => array('Illuminate\\Cache\\CacheManager', 'Illuminate\\Contracts\\Cache\\Factory'), 'cache.store' => array('Illuminate\\Cache\\Repository', 'Illuminate\\Contracts\\Cache\\Cache'), 'config' => array('Illuminate\\Config\\Repository', 'Illuminate\\Contracts\\Config\\Config'), 'cookie' => array('Illuminate\\Cookie\\CookieJar', 'Illuminate\\Contracts\\Cookie\\Factory', 'Illuminate\\Contracts\\Cookie\\QueueingFactory'), 'exception' => 'Illuminate\\Contracts\\Exception\\Handler', 'encrypter' => array('Illuminate\\Encryption\\Encrypter', 'Illuminate\\Contracts\\Encryption\\Encrypter'), 'db' => 'Illuminate\\Database\\DatabaseManager', 'events' => array('Illuminate\\Events\\Dispatcher', 'Illuminate\\Contracts\\Events\\Dispatcher'), 'files' => 'Illuminate\\Filesystem\\Filesystem', 'filesystem' => 'Illuminate\\Contracts\\Filesystem\\Factory', 'filesystem.disk' => 'Illuminate\\Contracts\\Filesystem\\Filesystem', 'filesystem.cloud' => 'Illuminate\\Contracts\\Filesystem\\Cloud', 'hash' => 'Illuminate\\Contracts\\Hashing\\Hasher', 'translator' => array('Illuminate\\Translation\\Translator', 'Symfony\\Component\\Translation\\TranslatorInterface'), 'log' => array('Illuminate\\Log\\Writer', 'Illuminate\\Contracts\\Logging\\Log', 'Psr\\Log\\LoggerInterface'), 'mailer' => array('Illuminate\\Mail\\Mailer', 'Illuminate\\Contracts\\Mail\\Mailer', 'Illuminate\\Contracts\\Mail\\MailQueue'), 'paginator' => 'Illuminate\\Pagination\\Factory', 'auth.reminder' => array('Illuminate\\Auth\\Reminders\\PasswordBroker', 'Illuminate\\Contracts\\Auth\\PasswordBroker'), 'queue' => 'Illuminate\\Queue\\QueueManager', 'queue.connection' => 'Illuminate\\Contracts\\Queue\\Queue', 'redirect' => 'Illuminate\\Routing\\Redirector', 'redis' => array('Illuminate\\Redis\\Database', 'Illuminate\\Contracts\\Redis\\Database'), 'request' => 'Illuminate\\Http\\Request', 'router' => 'Illuminate\\Routing\\Router', 'session' => 'Illuminate\\Session\\SessionManager', 'session.store' => array('Illuminate\\Session\\Store', 'Symfony\\Component\\HttpFoundation\\Session\\SessionInterface'), 'url' => array('Illuminate\\Routing\\UrlGenerator', 'Illuminate\\Contracts\\Routing\\UrlGenerator'), 'validator' => 'Illuminate\\Validation\\Factory', 'view' => array('Illuminate\\View\\Factory', 'Illuminate\\Contracts\\View\\Factory'));
...
class Router implements HttpKernelInterface, RegistrarContract, RouteFiltererInterface
{
    ...
    public function dispatchToRoute(Request $request)
    {
        ...
        if (is_null($response)) {
            $response = $route->run($request, $this->getControllerDispatcher());
        }
        $response = $this->prepareResponse($request, $response);
...
class Route
{
    ...
    public function run(Request $request, ControllerDispatcher $controllerDispatcher = null)
    {
        ...
        try {
            ...
            $parameters = $this->resolveMethodDependencies($parameters, new ReflectionFunction($this->action['uses']));
...
class PlainDisplayer implements ExceptionDisplayerInterface
{
    public function display(Exception $exception)
    {
        ...
        return new Response(file_get_contents('D:\\xampp\\htdocs\\github\\encuesta_umayor\\vendor\\laravel\\framework\\src\\Illuminate\\Exception' . '/resources/plain.html'), $status, $headers);
    }
}
namespace Illuminate\Exception;
...
class PrettyPageHandler extends Handler
{
    ...
    public function __construct()
    {
        ...
        $this->searchPaths[] = 'D:\\xampp\\htdocs\\github\\encuesta_umayor\\vendor\\filp\\whoops\\src\\Whoops\\Handler' . '/../Resources';
    }
    public function handle()
    {
...
class FilterServiceProvider extends ServiceProvider
{
    protected $before = array('App\\Http\\Filters\\MaintenanceFilter');
    protected $after = array();
    protected $filters = array('auth' => 'App\\Http\\Filters\\AuthFilter', 'auth.basic' => 'App\\Http\\Filters\\BasicAuthFilter', 'csrf' => 'App\\Http\\Filters\\CsrfFilter', 'guest' => 'App\\Http\\Filters\\GuestFilter');
}
namespace App\Providers;
...
class RouteServiceProvider extends ServiceProvider
{
    public function before()
    {
        URL::setRootControllerNamespace(trim(config('namespaces.controller'), '\\'));
    }
    public function map()
    {
        App::booted(function () {
