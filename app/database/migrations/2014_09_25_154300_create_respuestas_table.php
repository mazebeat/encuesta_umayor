...
class CreateRespuestasTable extends Migration {
	...
	public function up()
	{
		Schema::create('respuestas', function (Blueprint $table) {
			...
			$table->foreign('id_canal')->references('id_canal')->on('canales')->onDelete('cascade')->onUpdate('cascade');
			...
			$table->foreign('id_pregunta_detalle')->references('id_pregunta_detalle')->on('preguntas_detalle')->onDelete('cascade')->onUpdate('cascade');
