<?php
	...
	*/
	...
	Route::resource('negocio', 'NegociosController');
	...
	Route::get('test', function () {
		// ---------------------------------
		// $a = BddUmayor::find(1)->clientes;

		// Tools::printr($a);

		// ---------------------------------
		// $encrypted = Crypt::encrypt('centroantecion');
		// Tools::printr($encrypted);
		...
		return Redirect::to('/' . $hash_callcenter);
	});
